...
<div class="row justify-content-center">
    ...
    <h1 class="h3 text-center mb-3" style="font-weight:600;">Kasir<span class="text-primary">Ku</span></h1>
        ...
        <div class="text-center small mt-4">
            <p class="text-muted">Aplikasi Kasir by Ni Luh Novi Sugiantari </p>
        </div>
    </div>
